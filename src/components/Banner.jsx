            ...
            <div>
                <div className="space-y-4">
                    <div className="inline-flex items-center gap-2 bg-[#E1E7FF] text-sm font-medium px-5 py-2 rounded-full">
                        <span className="flex items-center gap-3 bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-transparent bg-clip-text"> <i className="fa-regular fa-circle-dot"></i> New: AI-Powered Tools Available</span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        ...
                        <button className="btn bg-transparent rounded-full border-purple-500 ">
                            <span className="flex gap-3 items-center bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-transparent bg-clip-text"> <i className="fa-solid fa-play"></i> Watch Demo</span>
                        </button>
                    </div>
                </div>
            </div>
